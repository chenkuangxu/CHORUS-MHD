    ...
    integer		::	nfp,ifpl,jfpl,ifpr,jfpr,ic,iface,sp,ifinter,sign_l,sign_r,k
    ...
    integer :: icleft,icright,ifacelc,ifacerc,faml,famr,k
    integer :: nfp,ifpl,jfpl,ifpr,jfpr,ic,iface,sp,ifinter
    ...
    do ifinter=1,NINTER
        ...
        faml = mod(ifacelc,2) + 1
        famr = mod(ifacerc,2) + 1
        !******************** to transform nablaQs into nablaQf ***************************************************
        do nfp=1,N
            ...
            !******************** now we have the Qf on either side of face
            !******************** and average nablaQf at the interfaces
            if(faml==1) then
